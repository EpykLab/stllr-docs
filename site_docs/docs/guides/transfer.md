...
## Option A: Upload a file { #option-a-upload-a-file }
...
### Sender: upload a file { #sender-upload-a-file }
...
## Option B: Stream a file { #option-b-stream-a-file }
...
### Sender: start a stream { #sender-start-a-stream }
...
### Receiver: receive a stream { #receiver-receive-a-stream }
