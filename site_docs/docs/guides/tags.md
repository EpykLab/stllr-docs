...
## Open the tag catalog { #open-the-tag-catalog }
...
## Create, rename, or delete a tag { #create-rename-or-delete-a-tag }
...
## Assign tags in Drive { #assign-tags-in-drive }
...
## Filter Drive by tags { #filter-drive-by-tags }
...
## Partner access and feature gating { #partner-access-and-feature-gating }
