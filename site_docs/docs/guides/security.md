...
## Export Logs to SIEM { #export-logs-to-siem }
...
### What Audit Logs Include { #what-audit-logs-include }
...
## Fetching Audit Logs via API { #fetching-audit-logs-via-api }
...
## Streaming Logs to SIEM { #streaming-logs-to-siem }
...
### Example: Sending to Splunk HEC { #example-sending-to-splunk-hec }
...
### Example: Sending to Elasticsearch/OpenSearch { #example-sending-to-elasticsearchopensearch }
