...
## Browse projects and folders { #browse-projects-and-folders }
...
## Share a file by email { #share-a-file-by-email }
...
## Policy attachments and evaluate { #policy-attachments-and-evaluate }
