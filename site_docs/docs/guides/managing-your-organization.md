...
## The organization admin { #the-organization-admin }
...
## Organization domains and name { #organization-domains-and-name }
...
<span id="organization-settings-organization-settings"></span>
...
### For invitees (accepting an invitation) { #for-invitees-accepting-an-invitation }
...
### What invitees cannot do { #what-invitees-cannot-do }
...
### Change a user’s role (RBAC) { #change-a-users-role-rbac }
