...
## Policies and control { #policies-and-control }
...
## Organization and settings { #organization-and-settings }
...
## Support and gate { #support-and-gate }
...
| Feature       | Description                                                                                                                                                     | Documentation                                                                         |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| Secure Viewer | Beta; server-rendered pixel-stream preview for supported Drive files; watermark (viewer email, timestamp); policy **`DRIVE_SECURE_VIEW`**                     | [Secure Viewer](/docs/security/secure-viewer/)                                        |
