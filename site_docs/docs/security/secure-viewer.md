...
## Why browser-side rendering is a concern { #why-browser-side-rendering-is-a-concern }
...
## What Secure Viewer does { #what-secure-viewer-does }
...
## External secure-view shares { #external-secure-view-shares }
...
## What Secure Viewer does not solve { #what-secure-viewer-does-not-solve }
