...
## The core idea: transfer is not a Drive object until you add it { #the-core-idea-transfer-is-not-a-drive-object-until-you-add-it }
...
## Layers of security (order matters) { #layers-of-security-order-matters }
...
### Bridge: upload and transfer lifecycle { #bridge-upload-and-transfer-lifecycle }
...
### Drive: objects, folders, and policies { #drive-objects-folders-and-policies }
...
### Projects: partner-scoped vs organization-only { #projects-partner-scoped-vs-organization-only }
...
## Why this matters for admins and auditors { #why-this-matters-for-admins-and-auditors }
