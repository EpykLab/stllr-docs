...
### Layer 1 — Fundamentals (What and Why) { #layer-1--fundamentals-what-and-why }
...
### Layer 2 — How it works in practice (User/Admin view) { #layer-2--how-it-works-in-practice-useradmin-view }
...
### Layer 3 — Administration and advanced options (Admin view) { #layer-3--administration-and-advanced-options-admin-view }
