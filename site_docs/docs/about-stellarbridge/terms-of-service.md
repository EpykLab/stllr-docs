...
## 1. Who the Customer Is { #1-who-the-customer-is }
...
## 3. Customer Responsibilities and Shared Responsibility Model { #3-customer-responsibilities-and-shared-responsibility-model }
...
### Shared Responsibility for Security { #shared-responsibility-for-security }

The Customer acknowledges and agrees that the security of the Service operates under a **shared responsibility model**, as documented at:
[Compliance with stellarbridge](/docs/compliance/compliance-with-stellarbridge/)
...
## 4. Acceptable Use and Prohibited Data { #4-acceptable-use-and-prohibited-data }
...
## 6. Access to File Contents { #6-access-to-file-contents }
...
## 7. Use of Non-Content Data { #7-use-of-non-content-data }
...
## 10. Data Retention and Deletion { #10-data-retention-and-deletion }
...
## 11. Customer Rights { #11-customer-rights }
...
## 12. Service Availability { #12-service-availability }
...
### Security-Related Limitation of Liability { #security-related-limitation-of-liability }
...
Email: [support@stellarbridge.com](mailto:support@stellarbridge.com)
