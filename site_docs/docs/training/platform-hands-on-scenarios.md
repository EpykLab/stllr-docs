...
# Stellarbridge Platform Hands-On Scenarios { #stellarbridge-platform-hands-on-scenarios }
...
### Role-based shortcuts { #role-based-shortcuts }
...
## Phase 1 — Transfers { #phase-1--transfers }

### TRN-001 — Send an invoice via upload transfer { #trn-001--send-an-invoice-via-upload-transfer }
...
### TRN-002 — Collect a W-2 via upload request { #trn-002--collect-a-w-2-via-upload-request }
...
### TRN-004 — Password-protected transfer { #trn-004--password-protected-transfer }
...
### TRN-005 — Org-locked transfer { #trn-005--org-locked-transfer }
...
### TRN-006 — Revoke an upload request { #trn-006--revoke-an-upload-request }
...
### TRN-007 — Custody report for a transfer { #trn-007--custody-report-for-a-transfer }
...
### TRN-008 — Add a transfer to Drive { #trn-008--add-a-transfer-to-drive }
...
### TRN-009 — Freeze a transfer during investigation { #trn-009--freeze-a-transfer-during-investigation }
...
### TRN-010 — Remove transfer password after counsel review { #trn-010--remove-transfer-password-after-counsel-review }
...
## Phase 2 — Drive { #phase-2--drive }

### DRV-001 — Select a project workspace { #drv-001--select-a-project-workspace }
...
### DRV-002 — Set up project folder structure { #drv-002--set-up-project-folder-structure }
...
### DRV-003 — Upload, rename, and delete { #drv-003--upload-rename-and-delete }
...
### DRV-004 — Share a Drive file by email { #drv-004--share-a-drive-file-by-email }
...
### DRV-005 — Drive search { #drv-005--drive-search }
...
### DRV-006 — Tag and filter Drive objects { #drv-006--tag-and-filter-drive-objects }
...
### DRV-007 — Assign a policy to a Drive folder { #drv-007--assign-a-policy-to-a-drive-folder }
...
### DRV-008 — Drive object custody report { #drv-008--drive-object-custody-report }
...
## Phase 3 — Policies and gate approval { #phase-3--policies-and-gate-approval }

### POL-001 — Create and activate a policy { #pol-001--create-and-activate-a-policy }
...
### POL-002 — Policy versioning and rollback { #pol-002--policy-versioning-and-rollback }
...
### POL-003 — Fork a policy { #pol-003--fork-a-policy }
...
### POL-004 — Policy scenario test { #pol-004--policy-scenario-test }
...
### POL-005 — Gate approval workflow { #pol-005--gate-approval-workflow }
...
### POL-006 — Review policy decisions { #pol-006--review-policy-decisions }
...
## Phase 4 — Forms { #phase-4--forms }

### FRM-001 — Create a personal intake form { #frm-001--create-a-personal-intake-form }
...
### FRM-002 — Publish a public form link { #frm-002--publish-a-public-form-link }
...
### FRM-003 — Review form responses { #frm-003--review-form-responses }
...
### FRM-004 — Org-owned template (FORM_ADMIN) { #frm-004--org-owned-template-form_admin }
...
### FRM-005 — Promote personal form to org-owned { #frm-005--promote-personal-form-to-org-owned }
...
### FRM-006 — Archive a form { #frm-006--archive-a-form }
...
### FRM-007 — Upload request with embedded form (Coming soon) { #frm-007--upload-request-with-embedded-form-coming-soon }
...
### FRM-008 — Form submit audit hygiene { #frm-008--form-submit-audit-hygiene }
...
## Phase 5 — Partners and groups { #phase-5--partners-and-groups }

### PRT-001 — Create a partner { #prt-001--create-a-partner }
...
### PRT-002 — Create an organization-scoped project { #prt-002--create-an-organization-scoped-project }
...
### PRT-003 — Create a partner-scoped project { #prt-003--create-a-partner-scoped-project }
...
### PRT-004 — Invite a partner external user { #prt-004--invite-a-partner-external-user }
...
### PRT-005 — Partner external user experience { #prt-005--partner-external-user-experience }
...
### PRT-006 — Assign project data custodian { #prt-006--assign-project-data-custodian }
...
### PRT-007 — Multi-partner project { #prt-007--multi-partner-project }
...
### PRT-008 — Revoke partner external access { #prt-008--revoke-partner-external-access }
...
### GRP-001 — Create a group for policy targeting { #grp-001--create-a-group-for-policy-targeting }
...
### GRP-002 — Remove user from group { #grp-002--remove-user-from-group }
...
## Phase 6 — Admin and security (Settings) { #phase-6--admin-and-security-settings }

### ADM-001 — Onboard a new user and assign roles { #adm-001--onboard-a-new-user-and-assign-roles }
...
### ADM-002 — Suspend user during investigation { #adm-002--suspend-user-during-investigation }
...
### ADM-003 — Export audit logs for a user { #adm-003--export-audit-logs-for-a-user }
...
### ADM-004 — Cancel a pending invitation { #adm-004--cancel-a-pending-invitation }
...
### ADM-006 — Add organization data custodian { #adm-006--add-organization-data-custodian }
...
### ADM-007 — Org security default: lock transfers to org { #adm-007--org-security-default-lock-transfers-to-org }
...
### ADM-008 — Create and rotate agent API key { #adm-008--create-and-rotate-agent-api-key }
...
### ADM-009 — Enable Forms feature for organization { #adm-009--enable-forms-feature-for-organization }
...
## Phase 7 — Investigation { #phase-7--investigation }

### AUD-001 — Filter audit event stream { #aud-001--filter-audit-event-stream }
...
### AUD-002 — Transfer audit mode { #aud-002--transfer-audit-mode }
...
### AUD-003 — Data flow identity lens { #aud-003--data-flow-identity-lens }
...
### AUD-004 — Data flow project lens { #aud-004--data-flow-project-lens }
...
### AUD-005 — Data flow partner lens { #aud-005--data-flow-partner-lens }
...
## Phase 8 — Productivity { #phase-8--productivity }

### PRD-001 — Command palette navigation { #prd-001--command-palette-navigation }
...
### PRD-002 — File workspace bootstrap wizard { #prd-002--file-workspace-bootstrap-wizard }
...
### Suggested workshop schedule (full curriculum) { #suggested-workshop-schedule-full-curriculum }
...
### Reset between cohorts { #reset-between-cohorts }
...
### Known beta / flag-gated items { #known-beta--flag-gated-items }
