...
declare module '$env/static/private' {
	...
	export const CURSOR_INVOKED_AS: string;
	...
	export const CURSOR_ASKPASS_SOCKET: string;
	...
	export const GLOBAL_AGENT_ENVIRONMENT_VARIABLE_NAMESPACE: string;
	...
	export const CURSOR_ASKPASS_SECRET: string;
