...
|------|-------|-------------|----------|
| 10000 | MessageAccessDenied | access denied | Authentication/Authorization |
...
| 11000 | MessageDatabaseRecordDeleteError | could not delete object from database | TargetDatabase |
...
| 12000 | MessageInvalidInput | invalid input provided | Validation |
...
| 13000 | MessageRequestTimeout | request timed out | Network/HTTP |
...
| 15000 | MessageProcessingFailed | processing failed | Processing |
| 15001 | MessageOperationCancelled | operation cancelled |  |
| 15002 | MessageAsyncTaskFailed | asynchronous task failed |  |
| 16000 | MessageConfigInvalid | invalid configuration | Configuration |
| 16001 | MessageEnvVarMissing | environment variable missing |  |
| 17000 | MessageExternalAPIError | external api error | External Services |
| 17001 | MessageIntegrationFailed | integration failed |  |
| 18000 | MessageInvalidState | invalid state | State |
| 18001 | MessageStateTransitionError | state transition error |  |
| 19000 | MessageInternalError | internal error | System |
| 19001 | MessageMaintenanceMode | system in maintenance mode |  |
| 19002 | MessageOperationSuccess | operation was successful |  |
| 20000 | MessageStorageContainerCheckError | error checking the availability of a storage account | TargetStorage |
...
| 21000 | MessageAccountDeletedAccount | a user deleted their account | TargetAccount Messages |
...
| 23000 | MessageTransferCreateError | error creating a transfer | TargetTransfer actions |
...
| 25000 | MessageAuth0UserDeleteSuccess | auth0 user deleted | TargetAuth0 actions |
...
| 25015 | MessageApiKeyCreateSuccess | API key created | API Key messages (25015-25024) |
...
| 26000 | MessagePolicyDecisionAllow | Policy engine allowed the action | Policy decision messages (26000-26099) - policy engine allow/deny for OCSF |
| 26001 | MessagePolicyDecisionDeny | Policy engine denied the action |  |
| 27000 | MessagePolicyCreateSuccess | access policy created | Policy CRUD messages (27000-27099) |
...
| 27100 | MessageNetworkRuleCreateSuccess | network rule created | Network rule messages (27100-27199) |
...
| 27200 | MessageVfsObjectCreateSuccess | VFS object created | VFS messages (27200-27299) |
...
| 27300 | MessageSupportNotifyPolicyDenialSuccess | policy denial notification sent | Support messages (27300-27399) |
...
| 27400 | MessageTermsAcceptSuccess | terms accepted | Terms messages (27400-27499) |
...
| 27500 | MessagePartnerCreateSuccess | partner created | Tenancy messages (27500-27599) |
...
| 27520 | MessageIdentityCreateSuccess | agent identity created | Identity (agent identity) messages (27520-27529) |
...
| 27530 | MessageGroupCreateSuccess | group created | Group messages (27530-27535) |
...
| 27536 | MessagePartnerIdentityCreateSuccess | partner external identity created | Partner external identity messages (27536-27543) |
